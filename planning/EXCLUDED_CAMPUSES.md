...
Campuses omitted from the current seed scope. Add in a future migration when coverage expands beyond Victoria.

| University | Campus | Reason |
|---|---|---|
| Monash University | Malaysia | International |
