...
- **Scraper Format:** Selectors must be compatible with the existing Python `Playwright` scraper engine.
- **Scraper Integration:** Must update the existing `scraper_configs` table in the PostgreSQL database.
